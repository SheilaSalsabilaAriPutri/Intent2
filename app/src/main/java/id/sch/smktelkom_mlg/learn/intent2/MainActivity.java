    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonInput).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(MainActivity.this, Input_activity.class), REQUEST_CODE);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                String nama = data.getStringExtra(Input_activity.NAMA);
                int thnLhr = data.getIntExtra(Input_activity.TAHUN_LAHIR, 0);
